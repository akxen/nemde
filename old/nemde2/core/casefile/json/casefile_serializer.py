...
from nemde.core.casefile.json.lookup import convert_to_list, get_intervention_status
...
if __name__ == '__main__':
    ...
    # This script deals with NEMDE case file directly (in JSON format) without prior preprocessing
    formatted_case = cdata

    t0 = time.time()
    case = parse_case_data(cdata, intervention_status)
    print(time.time() - t0)
