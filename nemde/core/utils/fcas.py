...
import nemde.core.utils.lookup as lookup
import nemde.core.utils.loaders as loaders
import nemde.core.utils.data as data_handler
...
def get_trader_fcas_availability_max_quantity_condition(data, trader_id, trade_type) -> bool:
...
def get_trader_fcas_availability_enablement_min_condition(data, trader_id, trade_type) -> bool:
...
def get_trader_fcas_availability_agc_status_condition(data, trader_id, trade_type) -> bool:
...
if __name__ == '__main__':
    ...
    # Calculation for given generator and trade type
