...
import nemde.core.utils.lookup
import nemde.core.utils.loaders
import nemde.core.utils.solution
import nemde.core.utils.analysis
import nemde.core.utils.database
import nemde.core.utils.validate
import nemde.core.utils.preprocessing
import nemde.core.utils.transforms.original.data
import nemde.core.utils.transforms.simplified.data
import nemde.core.utils.transforms.simplified.case
...
def solve_model_online(user_data):
    ...
    # Load case data
    base_case = nemde.core.utils.database.get_preprocessed_case_data(os.environ['MYSQL_DATABASE'], case_id)

    # Update case with user parameters
    updated_case = update(base_case, user_data)

    # Pre-process case file to be ingested by model
    transformed_case = nemde.core.utils.transforms.simplified.data.parse_case_data(updated_case, 'physical')
    preprocessed_case = nemde.core.utils.preprocessing.get_preprocessed_case_file(transformed_case)
